...
const sortByChildren = (charArray) => {
  var sorted_categories = charArray.sort(function (one, other) {
    return one.children.length - other.children.length;
 });
 return sorted_categories;
};
//source: https://stackoverflow.com/questions/2301856/how-to-sort-an-array-of-objects-based-on-a-the-length-of-a-nested-array-in-javas
