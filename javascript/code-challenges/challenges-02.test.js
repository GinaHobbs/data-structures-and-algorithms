...
const addQuestion = (arr) => {
  let questionArr = arr.map(function (val,i){
    return val + '?';
  })
  return questionArr;
};
...
const charCode = (arr) => {
  let charArr = arr.map(function (letter,i){
